...
if ($hassiteconfig) { // needs this condition or there is error on login page
	...
	$temp->add(new admin_setting_configtext('local_onlinejudge/rpath', get_string('rpath', 'local_onlinejudge'), get_string('rpath_help', 'local_onlinejudge'), '/usr/bin/Rscript', PARAM_PATH));
    $temp->add(new admin_setting_configtext('local_onlinejudge/tmppath', get_string('tmppath', 'local_onlinejudge'), get_string('tmppath_help', 'local_onlinejudge'), '/tmp/', PARAM_PATH));
