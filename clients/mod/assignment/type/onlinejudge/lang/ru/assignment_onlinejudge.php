...
$string['addtestcases'] = 'Добавить {$a} тестовых пар';
$string['assignmentlangs'] = 'Язык программирования';
$string['badtestcasefile'] = 'Файл не существует или не может быть прочитан';
$string['cannotruncompiler'] = 'Невозможно выполнить скрипт компилятора';
$string['case'] = 'Case {$a}:';
$string['compileonly'] = 'Только компиляция';
$string['compileonly_help'] = 'Если выбрано, программа будет скомпилирована, но не запущена. Оценка производится в ручную преподавателем';
$string['compiler'] = 'Компилятор';
$string['configmaxcpu'] = 'Максимальное время работы по-умолчанию для всех заданий (subject to other local settings)';
$string['configmaxmem'] = 'Максимальный объем используемой памяти для всех заданий (subject to other local settings)';
$string['cpulimit'] = 'Максимальное время выполнения';
$string['denytoreadfile'] = 'У вас нет прав на чтение этого файла';
...
$string['filereaderror'] = 'Невозможно прочитать файл';
$string['forcejudge'] = 'Принудительная проверка';
$string['ideoneuser'] = 'Имя пользователя Ideone';
$string['ideoneuser_help'] = 'Если выбрана проверка на ideone.com, вы должны указать имя пользователя <a href="http://ideone.com">ideone.com</a>.';
$string['ideonepass'] = 'Пароль для ideone API';
$string['ideonepass_help'] = 'Это парольне для ideone.com, а для ideone <em>API</em>. Вы можете изменить пароль для API здесь <a href="https://ideone.com/account/">https://ideone.com/account/</a>.';
$string['ideonepass2'] = 'Повторите ввод API-пароля';
$string['ideonepassmismatch'] = 'Пароли не совпадают';
$string['input'] = 'Input';
...
$string['managetestcases'] = 'Редактировать тестовые пары';
...
//MY STRINGS
$string['generateojassignments'] = 'Generate Assignments for this course';
$string['replaceassignment'] = 'Заново сгенерировать это задание';
$string['assignmenttemplate'] = 'Выберите Rnw-описание';
$string['testqtt'] = 'Выберите количество тестовых пар';
