...
$string['execscript'] = 'Execute Script';
$string['replaceassignment'] = 'Regenerate this assignment';
$string['assignmenttemplate'] = 'Choose assignment template';
$string['testqtt'] = 'Choose the number of testpairs';
