...
$string['rpath'] = 'Rscript binary path';
$string['rpath_help'] = 'Path to Rscript binary on your server';
$string['tmppath'] = 'Path to the temp folder needed by exams package';
$string['tmppath_help'] = 'The directory must be writable by the server in order for exams to work';
